...
const helpSteps = [
  ...
  {
    persian: {
      title: "مرحله 2: آپلود سند و پرکردن فرم مربوطه",
      details:
  ...
  {
    persian: {
      title: "مرحله 3: تأیید و پذیرش درخواست ترجمه",
      details:
  ...
  {
    persian: {
      title: "مرحله 4: پرداخت هزینه ترجمه",
      details:
