...
class SendExpiryEmail extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
          ...
          this.state.ids.length >= 1 ? (
            <div>
              <Typography align={"center"}>
                <div>
                  {
                    "Voulez-vous vraiment envoyer des messages à ces utilisateurs?"
                  }
                </div>
                <div dir={"rtl"}>
                  {"آیا از ارسال پیام به این کاربران اطمینان دارید؟"}
                </div>
            ...
            <div>
              <Typography align={"center"}>
                <div>
                  {"Il n'y a pas d'utilisateur pour envoyer le message"}
                </div>
                <div dir={"rtl"}>{"کاربری برای ارسال پیام وجود ندارد"}</div>
              </Typography>
            </div>
          )
        }
...
export default SnackbarWrapper(SendExpiryEmail);
SendExpiryEmail.propTypes = {
